...
public class UI_WeaponSellectionButton : UI_Button
{
    ...
    public override void OnPointerDown(PointerEventData eventData)
    {
        ...
        bool noThisWeaponInSlot = weaponSelectionUI.FindSlowWithWeaponOfType(weaponData) == null;

        if (noMoreEmptySlots && noThisWeaponInSlot)
        {
